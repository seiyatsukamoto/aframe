...
LAW_CONFIG_FILE=/home/seiya.tsukamoto/aframe/low-high-pass-multimodal/sandbox.cfg uv run --directory /home/seiya.tsukamoto/aframe law run aframe.pipelines.sandbox.Sandbox --workers 5 --gpus 0,1,2,3,4,5,6,7 --dev
