...
class MLPAframeDataset(SupervisedAframeDataset):
    ...
    def build_val_batches(self, background, signals):
        ...
        X_bg_1 = self.timedomain_model.compress1(X_bg_1)
        X_bg_1 = F.relu(X_bg_1)
        B, C, W = X_bg_1.size()
        X_bg_1 = X_bg_1.view(B, C*W)
        X_bg_1 = self.timedomain_model.compress2(X_bg_1)
        ...
        X_bg_2 = self.spectrogram_model.compress1(X_bg_2)
        X_bg_2 = F.relu(X_bg_2)
        B, C, W, H = X_bg_2.size()
        X_bg_2 = X_bg_2.view(B, C*W*H)
        X_bg_2 = self.spectrogram_model.compress2(X_bg_2)
        ...
        for inj in X_inj:
            ...
            inj_1 = self.timedomain_model.compress1(inj_1)
            inj_1 = F.relu(inj_1)
            B, C, W = inj_1.size()
            inj_1 = inj_1.view(B, C*W)
            inj_1 = self.timedomain_model.compress2(inj_1)
            ...
            inj_2 = self.spectrogram_model.compress1(inj_2)
            inj_2 = F.relu(inj_2)
            B, C, W, H = inj_2.size()
            inj_2 = inj_2.view(B, C*W*H)
            inj_2 = self.spectrogram_model.compress2(inj_2)
