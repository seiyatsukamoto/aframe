...
class MultimodalMultibandDataset_plot(SupervisedAframeDataset):
    def __init__(self,
        ...
        self.template_to_test = template_to_test
    ...
    def augment(self, X, waveforms):
        ...
        template = self.templates[self.template_to_test]
        for band, kl in enumerate(self.kernel_lengths[1:]):
            sliced_waveforms = batch[0][:, :, template]
