...
from train.data.resampled_hdf5_dataset_v3 import ResampledHdf5TimeSeriesDataset_v3
...
class ResampledAframeDataset_v3(SupervisedAframeDataset):
    def __init__(
        self,
        ...
        **kwargs
        ...
        self.downsample_rate = int(self.file_sample_rate/self.hparams.sample_rate)
    ...
    def load_val_waveforms(self, f, world_size, rank):
        ...
        waveforms = waveforms[..., ::self.downsample_rate]
        return waveforms
        ...
        for fname in fnames:
            ...
            with h5py.File(fname, "r") as f:
                for ifo in self.hparams.ifos:
                    segment.append(torch.tensor(f[ifo][::self.downsample_rate], dtype = torch.float))
    ...
    def train_dataloader(self) -> torch.utils.data.DataLoader:
        ...
        dataset = ResampledHdf5TimeSeriesDataset_v3(
            self.train_fnames,
