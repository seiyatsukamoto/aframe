...
LAW_CONFIG_FILE=/home/seiya.tsukamoto/aframe/layered/sandbox.cfg uv run --directory /home/seiya.tsukamoto/aframe law run aframe.pipelines.sandbox.Sandbox --workers 5 --gpus 0,1 --dev
