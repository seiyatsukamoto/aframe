...
from architectures.networks import ResNet1D_encoder
from architectures.networks import ResNet1D_decoder
from ml4gw.nn.norm import GroupNorm2DGetter, NormLayer
from architectures.networks import ResNet2D_encoder
from architectures.networks import ResNet2D_decoder
...
class ResNet1D_autoencoder(SupervisedArchitecture):
    def __init__(
        self,
        in_channels: int,
        layers: list[int],
